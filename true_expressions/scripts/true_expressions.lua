...
local plausibleExtras = {"alchemical", "armor", "circumstance", "competence", "deflection", "dodge", "enhancement", "insight", "luck", "morale", "natural", "profane", "racial", "resistance", "sacred", "shield", "size", "melee", "ranged", "acid", "cold", "electricity", "fire", "sonic", "force", "negative", "positive", "adamantine", "bludgeoning", "cold iron", "epic", "magic", "piercing", "silver", "slashing", "chaotic", "evil", "good", "lawful", "nonlethal", "spell", "strength", "constitution", "dexterity", "intelligence", "wisdom", "charisma", "acrobatics", "appraise", "bluff", "climb", "craft", "diplomacy", "disable device", "disguise", "escape artist", "fly", "handle animal", "heal", "intimidate", "knowledge", "linguistics", "perception", "profession", "ride", "sense motive", "sleight of hand", "spellcraft", "stealth", "survival", "swim", "use magic device", "opportunity", "all"};
